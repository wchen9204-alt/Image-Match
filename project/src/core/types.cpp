...
std::string toString(FeatureType t) {
    switch (t) {
        ...
        case FeatureType::SURF:    return "SURF";
...
FeatureType featureTypeFromString(const std::string& s) {
    ...
    if (u == "SURF")  return FeatureType::SURF;
    if (u == "ORB")   return FeatureType::ORB;
    if (u == "BRISK") return FeatureType::BRISK;
    if (u == "KAZE")  return FeatureType::KAZE;
...
std::string toString(NormType t) {
    switch (t) {
        case NormType::L1:       return "L1";
        case NormType::L2:       return "L2";
        case NormType::HAMMING:  return "HAMMING";
        case NormType::HAMMING2: return "HAMMING2";
...
NormType normTypeFromString(const std::string& s) {
    const std::string u = toUpper(s);
    if (u == "L1")       return NormType::L1;
    if (u == "L2")       return NormType::L2;
    if (u == "HAMMING")  return NormType::HAMMING;
    if (u == "HAMMING2") return NormType::HAMMING2;
    if (u == "AUTO")     return NormType::UNKNOWN;
    return NormType::UNKNOWN;
}

int toCvNorm(NormType t) {
    switch (t) {
        case NormType::L1:       return cv::NORM_L1;
        case NormType::L2:       return cv::NORM_L2;
        case NormType::HAMMING:  return cv::NORM_HAMMING;
        case NormType::HAMMING2: return cv::NORM_HAMMING2;
        case NormType::UNKNOWN:
        default:                 return cv::NORM_L2;
    }
}
...
int robustMethodFromString(const std::string& s) {
    const std::string u = toUpper(s);
    if (u == "RANSAC") return cv::RANSAC;
    if (u == "LMEDS")  return cv::LMEDS;
    if (u == "RHO")    return cv::RHO;
    if (u == "7POINT") return cv::FM_7POINT;
    if (u == "8POINT") return cv::FM_8POINT;
    if (u == "NONE" || u == "0") return 0;
    return -1;
}
